...
export const metadata: Metadata = {
  ...
  description: "The Speedglas G5-01 VC Heavy Duty Flip Up Welding Helmet with Adflo PAPR is the highly anticipated and newest welding helmet with PAPR from the team that invented the auto darkening welding helmet.",
};
...
export default function Product({params}:{params:{id:string}}) {
  ...
  return (
    <div className='w-full p-4 container m-auto'>
      ...
      <div dangerouslySetInnerHTML={{__html: productDetail.description3}} className='mb-4'></div>
